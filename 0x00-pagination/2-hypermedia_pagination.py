...
class Server:
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> Dict:
        """Return extra/hyper information about a page.

        Returns this info in dictionary format:
            page_size, page number, data, next_page, prev_page and total_pages
        """
